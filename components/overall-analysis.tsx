    ...
    <div className="space-y-8">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-3xl font-bold text-blue-900 dark:text-blue-100">
                  {data.total_stats?.total_messages || 0}
                </p>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-3xl font-bold text-green-900 dark:text-green-100">
                  {data.total_stats?.total_participants || 2}
                </p>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-3xl font-bold text-purple-900 dark:text-purple-100">
                  {data.total_stats?.conversation_span || "N/A"}
                </p>
                <p className="text-sm text-purple-700 dark:text-purple-300">Time Span</p>
              </div>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-3xl font-bold text-orange-900 dark:text-orange-100">
                  {data.total_stats?.avg_daily_messages || 0}
                </p>
                <p className="text-sm text-orange-700 dark:text-orange-300">Daily Average</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <Card className="border-2 border-gray-200 bg-white shadow-lg dark:bg-gray-900 dark:border-gray-800">
          <CardHeader className="border-b border-gray-100 dark:border-gray-800 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950/50 dark:to-purple-950/50">
          ...
          <CardContent className="p-6">
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <span className="font-medium text-gray-700 dark:text-gray-300">Relationship Type</span>
                <Badge className="bg-blue-500 text-white">{data.relationship_type}</Badge>
              </div>
              <div className="flex justify-between items-center">
                <span className="font-medium text-gray-700 dark:text-gray-300">Current Stage</span>
                <Badge className="bg-purple-500 text-white">{data.relationship_stage}</Badge>
              </div>
              <div className="flex justify-between items-center">
                <span className="font-medium text-gray-700 dark:text-gray-300">Communication Health</span>
        ...
        <Card className="border-2 border-gray-200 bg-white shadow-lg dark:bg-gray-900 dark:border-gray-800">
          <CardHeader className="border-b border-gray-100 dark:border-gray-800 bg-gradient-to-r from-green-50 to-teal-50 dark:from-green-950/50 dark:to-teal-950/50">
            <CardTitle className="text-black dark:text-white flex items-center gap-2">
              ...
              <div className="relative w-32 h-32">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <div className="text-sm text-gray-600 dark:text-gray-400">Compatible</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <Card className="border-2 border-gray-200 bg-white shadow-lg dark:bg-gray-900 dark:border-gray-800">
        <CardHeader className="border-b border-gray-100 dark:border-gray-800 bg-gradient-to-r from-indigo-50 to-blue-50 dark:from-indigo-950/50 dark:to-blue-950/50">
          <CardTitle className="text-black dark:text-white flex items-center gap-2">
          ...
          <div className="space-y-6">
            {timelineData.map((period, index) => (
              <div key={index} className="space-y-3">
                <h4 className="font-medium text-black dark:text-white">{period.period}</h4>
        ...
        <CardContent className="p-6">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {data.dominant_emotions?.map((emotion, index) => (
              <div
                key={index}
                className="bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-lg p-4 text-center hover:shadow-md transition-shadow dark:from-blue-950/50 dark:to-indigo-950/50 dark:border-blue-800"
              >
                ...
                <span className="font-medium text-blue-800 dark:text-blue-200 capitalize">{emotion}</span>
              </div>
            )) || (
              <>
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-lg p-4 text-center dark:from-blue-950/50 dark:to-indigo-950/50 dark:border-blue-800">
                  <div className="text-2xl mb-2">💙</div>
                  <span className="font-medium text-blue-800 dark:text-blue-200">Trust</span>
                </div>
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-lg p-4 text-center dark:from-blue-950/50 dark:to-indigo-950/50 dark:border-blue-800">
                  <div className="text-2xl mb-2">🤝</div>
                  <span className="font-medium text-blue-800 dark:text-blue-200">Support</span>
                </div>
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-lg p-4 text-center dark:from-blue-950/50 dark:to-indigo-950/50 dark:border-blue-800">
                  <div className="text-2xl mb-2">💕</div>
                  <span className="font-medium text-blue-800 dark:text-blue-200">Affection</span>
                </div>
              </>
            )}
          </div>
      ...
      <div className="space-y-6">
        <div className="text-center border-b border-gray-200 dark:border-gray-700 pb-4">
          <h2 className="text-3xl font-bold text-black dark:text-white">Individual Analysis</h2>
          <p className="text-gray-600 dark:text-gray-400">Detailed profile of each participant</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {participants.map((participant, index) => (
            <Card
              key={participant}
              className="border-2 border-gray-200 bg-white shadow-lg dark:bg-gray-900 dark:border-gray-800"
            >
              <CardHeader
                className={`border-b border-gray-100 dark:border-gray-800 bg-gradient-to-r ${
                  index === 0
              ...
              >
                <CardTitle className="text-black dark:text-white flex items-center gap-2">
                  <User
                    className={`h-5 w-5 ${index === 0 ? "text-blue-600 dark:text-blue-400" : "text-purple-600 dark:text-purple-400"}`}
                  />
                  {participant}
                </CardTitle>
              </CardHeader>
              <CardContent className="p-6">
                <div className="space-y-4">
                  {data.individual_analysis?.[participant] ? (
                    <>
                      <div>
                        <h4 className="font-medium text-black dark:text-white mb-2">Communication Style</h4>
                        <p className="text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-800 p-3 rounded-lg border border-gray-200 dark:border-gray-700">
                          {data.individual_analysis[participant].communication_style}
                        </p>
                      </div>

                      <div>
                        <h4 className="font-medium text-black dark:text-white mb-2">Personality Traits</h4>
                      ...
                      <div>
                        <h4 className="font-medium text-black dark:text-white mb-2">Emotional Patterns</h4>
                        <p className="text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-800 p-3 rounded-lg border border-gray-200 dark:border-gray-700">
                      ...
                      <div>
                        <h4 className="font-medium text-black dark:text-white mb-2">Detailed Profile</h4>
                        <p className="text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-800 p-3 rounded-lg border border-gray-200 dark:border-gray-700">
      ...
      <Card className="border-2 border-gray-200 bg-white shadow-lg dark:bg-gray-900 dark:border-gray-800">
        <CardHeader className="border-b border-gray-100 dark:border-gray-800 bg-gradient-to-r from-pink-50 to-red-50 dark:from-pink-950/50 dark:to-red-950/50">
          <CardTitle className="text-black dark:text-white flex items-center gap-2">
            <Heart className="h-5 w-5 text-red-500" />
        ...
        <CardContent className="p-6">
          <div className="prose max-w-none dark:prose-invert">
            {data.compatibility_factors ? (
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-base">{data.compatibility_factors}</p>
            ) : (
              <div className="space-y-4">
      ...
      <Card className="border-2 border-gray-200 bg-white shadow-lg dark:bg-gray-900 dark:border-gray-800">
        <CardHeader className="border-b border-gray-100 dark:border-gray-800 bg-gradient-to-r from-rose-50 to-pink-50 dark:from-rose-950/50 dark:to-pink-950/50">
          <CardTitle className="text-black dark:text-white flex items-center gap-2">
      ...
      <Card className="border-2 border-gray-200 bg-white shadow-lg dark:bg-gray-900 dark:border-gray-800">
        <CardHeader className="border-b border-gray-100 dark:border-gray-800 bg-gradient-to-r from-purple-50 to-violet-50 dark:from-purple-950/50 dark:to-violet-950/50">
          <CardTitle className="text-black dark:text-white flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <Card className="border-2 border-gray-200 bg-white shadow-lg dark:bg-gray-900 dark:border-gray-800">
          <CardHeader className="border-b border-gray-100 dark:border-gray-800 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/50 dark:to-emerald-950/50">
            <CardTitle className="text-black dark:text-white flex items-center gap-2">
        ...
        <Card className="border-2 border-gray-200 bg-white shadow-lg dark:bg-gray-900 dark:border-gray-800">
          <CardHeader className="border-b border-gray-100 dark:border-gray-800 bg-gradient-to-r from-yellow-50 to-amber-50 dark:from-yellow-950/50 dark:to-amber-950/50">
            <CardTitle className="text-black dark:text-white flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              <div>
                <div className="flex justify-between items-center mb-2">
                  <span className="font-medium text-gray-700 dark:text-gray-300">Empathy Level</span>
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  <span className="font-medium text-gray-700 dark:text-gray-300">Conflict Resolution</span>
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  <span className="font-medium text-gray-700 dark:text-gray-300">Emotional Support</span>
        ...
        <Card className="border-2 border-gray-200 bg-white shadow-lg dark:bg-gray-900 dark:border-gray-800">
          <CardHeader className="border-b border-gray-100 dark:border-gray-800 bg-gradient-to-r from-red-50 to-pink-50 dark:from-red-950/50 dark:to-pink-950/50">
            <CardTitle className="text-black dark:text-white flex items-center gap-2">
          ...
          <CardContent className="p-6">
            <div className="space-y-4">
              <div>
                <div className="flex justify-between items-center mb-2">
                  <span className="font-medium text-gray-700 dark:text-gray-300">Trust Level</span>
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  <span className="font-medium text-gray-700 dark:text-gray-300">Intimacy Level</span>
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  <span className="font-medium text-gray-700 dark:text-gray-300">Vulnerability Sharing</span>
      ...
      <Card className="border-2 border-gray-200 bg-white shadow-lg dark:bg-gray-900 dark:border-gray-800">
        <CardHeader className="border-b border-gray-100 dark:border-gray-800 bg-gradient-to-r from-slate-50 to-gray-50 dark:from-slate-950/50 dark:to-gray-950/50">
          <CardTitle className="text-black dark:text-white flex items-center gap-2">
        ...
        <CardContent className="p-6">
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-700 dark:text-gray-300 bg-blue-50 dark:bg-blue-950/30 p-4 rounded-lg border border-blue-200 dark:border-blue-800 leading-relaxed">
            ...
            <div>
              ...
              <p className="text-gray-700 dark:text-gray-300 bg-red-50 dark:bg-red-950/30 p-4 rounded-lg border border-red-200 dark:border-red-800 leading-relaxed">
